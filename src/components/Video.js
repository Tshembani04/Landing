    ...
    <div className="bg-[#534686]/30 py-6  ">
      <div className="container mx-auto">
        <div className="flex flex-col justify-center items-center text-center lg:flex-row lg:justify-between" >
          <h3 className="text-2xl font-semibold mb-8 lg:mb-0" >Awesome experience with virtual reality world</h3>
          {/* Modal */}
          <ModalVideo
            channel="youtube"
            autoplay
          ...
          >
            <div className="cursor-pointer">
              <BsPlayCircleFill className="text-4xl text-white/80 hover:text-white hover:scale-110 trasnition" />
            </div>
          </div>
        </div>
      </div>
