...
const Nav = () => {
  return (
    <nav className='hidden lg:flex'>
      <ul className='flex items-center space-x-12  font-secondary lg:leading-snug' >
        <li className='nav-link'><a href="">Home</a></li>
        <li className='nav-link'><a href="">Content Production</a></li>
        ...
        <li className='nav-link'><a href="">Demos & Brochures</a></li>
        <li className='nav-link'><a href="">Blog</a></li>
        <li className='nav-link'><a href="">Vaccancies</a></li>
      </ul>
    </nav>
  )
};
